...
final class Version20220408233328 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `project` (`id` int(11) NOT NULL AUTO_INCREMENT,`creator_id` int(11) NOT NULL,`vico_id` int(11) DEFAULT NULL,`created` datetime NOT NULL,`title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,PRIMARY KEY (`id`),KEY `IDX_2FB3D0EE19F89217` (`vico_id`),KEY `creator_idx` (`creator_id`),KEY `created_idx` (`created`),CONSTRAINT `FK_2FB3D0EE19F89217` FOREIGN KEY (`vico_id`) REFERENCES `vico` (`id`),CONSTRAINT `FK_2FB3D0EE61220EA6` FOREIGN KEY (`creator_id`) REFERENCES `client` (`id`)) ENGINE=InnoDB');
        $this->addSql('CREATE TABLE member (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(64) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rating (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, project_id INT NOT NULL, score INT NOT NULL, comment VARCHAR(255) NOT NULL, INDEX IDX_D8892622166D1F9C (project_id), INDEX IDX_D889262219EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rating_detail (id INT AUTO_INCREMENT NOT NULL, rating_id INT NOT NULL, rating_aspect_id INT NOT NULL, score INT NOT NULL,INDEX IDX_D8892622166D1F9C (rating_id), INDEX IDX_D889262219EB6921 (rating_aspect_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rating_aspect (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(64) NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE rating_detail ADD CONSTRAINT FK_D8892622166W45T3 FOREIGN KEY (rating_id) REFERENCES rating (id)');
        $this->addSql('ALTER TABLE rating_detail ADD CONSTRAINT FK_D889262219EHT65F FOREIGN KEY (rating_aspect_id) REFERENCES rating_aspect (id)');
    }
